...
src3.addEventListener('touchmove', (e) => {
   
    
        let dokY = document.getElementById("wskaznik").offsetHeight;
        let dokYmargin2 = document.getElementById("pokretlo").getBoundingClientRect().top;
...
$('#An00').bind('mousedown', function(e){
    if(wybor == 0)
    {
        let Y = e.pageY-document.getElementById("An00").getBoundingClientRect().top;
      ...
      .then(
           function()
           {
            ...
            if(getid.length==6 && getid[3]+getid[4]+getid[5]==screen)
            {
                ...
                funtimer();
                setTimeout( function(){
                $.post("https://human-tech-hackaton-22.vercel.app/api/computer-code", dataObject)},11000)
